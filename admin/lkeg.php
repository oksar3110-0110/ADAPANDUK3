...
<div class='navbar navbar-inverse'>
  <div class='navbar-header'>
    <div class="navbar-text"><i class="fa fa-file"></i> LAPORAN KEGIATAN</div>
  </div>
</div>
  <div>
  <form method="POST" action="https://sertifikasi.lsptik.or.id/report">
    ...
    <table class="table table-striped table-bordered table-hover" cellspacing="0" width="100%">
      ...
      <?php
                ...
                $result = mysqli_query($link, "SELECT * FROM laporankegiatanpos");
    ...
    <?php
       ...
       $sqlCommand = "SELECT COUNT(*) FROM laporankegiatanpos"; 
        $query = mysqli_query($konek, $sqlCommand) or die (mysqli_error()); 
        $row = mysqli_fetch_row($query);
        echo "Ada " . $row[0] . " Laporan Kegiatan.";
