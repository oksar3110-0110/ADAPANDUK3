...
<form method="post" action="">
    ...
    $hasil = mysqli_query($link, "SELECT * FROM petugas WHERE nm_pet = '".$nam."'");
	...
	<input class="form-control" type="text" style="background-color: white; border-radius: 5px;" name="namap" value=<?php echo "$row[0]";?>></input><br><br>
      ...
      <input class="form-control" type="text" style="background-color: white; border-radius: 5px;" name="user" value=<?php echo "$row[2]";?>></input><br><br>
      <input class="form-control" type="text" style="background-color: white; border-radius: 5px;" name="pass" value=<?php echo "$row[3]";?>></input><br><br>
      <input class="form-control" type="text" style="background-color: white; border-radius: 5px;" name="pos" value=<?php echo "$row[4]";?>></input><br><br>
...
if (isset($_POST['update'])) {
    $link = mysqli_connect("localhost", "root", "", "adapandu");
    $up = mysqli_query ($link, "UPDATE petugas SET nm_pet = '".$_POST['namap']."' , alamat_pet = '".$_POST['palamat']."',user = '".$_POST['user']."',pass = '".$_POST['pass']."',nm_pos = '".$_POST['pos']."' where nm_pos = '".$nam."'");
    
    echo $up;
    echo '<script language="javascript">alert("Data Berhasil di UPDATE!"); document.location="viewpetugas.php";</script>';
